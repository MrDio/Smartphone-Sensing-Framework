\begin{abstract}
LapOps is an Android App about recognising race tracks with their sections and improving racing performance by giving tips based on the performance analysis of each section.

Therefore two sensors of a smartphone had to be used. By measuring forces on the car with an accelerometer and identifying different laps with the activation of an proximeter triggered by a bridge at the start of each lap, a race track can be identified surprisingly precise.
