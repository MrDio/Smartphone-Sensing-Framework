...
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.GPS.gps;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.GPS.gpsSim;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.accelerometer.accelerometer;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.accelerometer.accelerometerSim;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.gyroscope.gyro;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.gyroscope.gyroSim;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.magnetometer.magneto;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.magnetometer.magnetoSim;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.microphone.microSim;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.microphone.microphone;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.proximity.proxiSim;
import com.example.ldg8fe.rapiddisruption.hardwareAdapter.proximity.proximity;
